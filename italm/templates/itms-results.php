...
<script language="javascript" src="<?= get_option('site_url') ?>/wp-content/plugins/italm/templates/common.js">
</script>
<link rel="stylesheet" type="text/css" href="<?= get_option('site_url') ?>/wp-content/plugins/italm/templates/common.css">
</head>
<body>
